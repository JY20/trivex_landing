      ...
      <StackColumn>
        <Stack direction="row" spacing={2} justifyContent="center" alignItems="center">
          <div className="bg-white w-full h-auto py-8 flex items-center justify-center gap-4 flex-wrap">
            <a target="_blank" rel="noreferrer noopener" href="https://x.com/trivex_xyz" aria-label="X">
            ...
            <a target="_blank" rel="noreferrer noopener" href="https://discord.gg/EQGmqBkBfj" aria-label="Discord">
              <svg viewBox="0 0 20 20" width="3vh" height="3vh" color="textSubtle" xmlns="http://www.w3.org/2000/svg">
